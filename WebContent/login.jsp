						...
						<form action="AjioServlet" method="post">
							...
							<div class="row">
								...
								<div class="input-container col-8">
									...
									placeholder="Enter Email" name="email1" required> <br>
								</div>
							...
							<div class="row">
								<label for="pwd1" class="col-4" ><span style="font-size:24px;font-weight:bold;">Password: </i></span> </label>
								 ...
								 <div class="input-container col-8">
									...
									placeholder="Enter password" name="pwd1" required >
								</div>
							</div>
							</div>
					</div>
							...
							<div class="row">
								<label for="pwd" class="col-4" ><span style="font-size:24px;font-weight:bold;">Password:</span></label>
								 ...
								 <div class="input-container">
	    							<i class="fa fa-key icon"></i>
									 <input type="password" class="form-control shadow-lg" id="pwd"
										placeholder="Enter password" name="pwd" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
										
								</div>
								<i>Please click login twice after completion of validation in password</i>
								</div>
							</div>
							</div>
							<div id="message">
